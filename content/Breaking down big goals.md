...
- Can help us bypass demotivation from [[Temporal Discounting]] by making things more urgent
- Switching things up into different goals can help prevent [[boredom]]
## Examples
### Example 1
...
# Backlinks
```dataview
list from [[Breaking down big goals]] AND !outgoing([[Breaking down big goals]])
```
___
References:
