...
## Next Steps
**A)** Read the [Benefits of IMF](out/benefits-of-imf.md).

**B)** Or [start setting up your IMF frameworks](out/setting-up-imf.md).

**C)** Or jump to [ The Index](out/index-archived.md) and start playing around.


[^1]: Yes, that means it's the "Index Maps and Frameworks framework", which is accurate in describing the overall framework.
[^2]: The idea of structures or categories that help without limiting the user was given the name [Fluid Taxonomies](out/fluid-taxonomies.md), an excellent term coined by @mediapathic.