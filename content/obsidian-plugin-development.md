...
- [](None)
## Plugin Plans
- [Obsidian x Habitica Integration](out/obsidian-x-habitica-integration.md)
## Skills Needed
- [JavaScript MOC](out/javascript-moc.md)
- [TypeScript](out/typescript.md)
- npm ([Node.js](out/node.js.md))
- git
## Resources
...
# Backlinks
```dataview
list from [Obsidian Plugin Development](out/obsidian-plugin-development.md) AND !outgoing([Obsidian Plugin Development](out/obsidian-plugin-development.md))
```
___
References:
